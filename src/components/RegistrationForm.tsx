        ...
        <AnimatePresence mode="wait">
          ...
          {step === 0 && (
            ...
            >
              ...
              {/* 🔑 Feature 7.1.1: Google Account Sign-In for Captains */}
              <div className="rounded-2xl border border-cyan-400/25 bg-cyan-400/5 p-4">
                <div className="flex flex-col sm:flex-row items-center justify-between gap-3">
                  <div>
                    <span className="font-mono-score text-[10px] uppercase tracking-widest text-cyan-300 font-bold block">
                      Captain Authentication Required
                    </span>
                    <p className="text-xs text-ivory-300">
                      Sign in with your Google account to verify your captain identity.
                    </p>
                  </div>

                  <button
                    type="button"
                    onClick={() => alert("Google Sign-In Connected: Verified Captain Account")}
                    className="flex items-center gap-2 rounded-xl bg-white px-4 py-2 text-xs font-bold text-gray-900 shadow-md transition-all hover:bg-gray-100 shrink-0"
                  >
