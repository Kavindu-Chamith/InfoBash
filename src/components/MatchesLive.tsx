    ...
    return (
      <div className="relative z-10 mx-auto max-w-4xl px-6 py-16 text-center">
        <div className="glass-card glow-border relative overflow-hidden rounded-3xl p-8 sm:p-12">
          ...
          <div className="mx-auto grid h-20 w-20 place-items-center rounded-3xl bg-cyan-500/20 border border-cyan-400/40 text-cyan-300 shadow-[0_0_35px_-5px_rgba(53,215,255,0.4)]">
            <Trophy size={36} />
          </div>
    ...
    <div className="relative z-10 mx-auto max-w-6xl px-4 py-6 sm:px-6">
      ...
      {(STAGE_LEVELS[selectedRound] ?? 1) > (STAGE_LEVELS[serverLiveRound] ?? 1) ? (
        <div className="mx-auto max-w-2xl py-12 text-center">
          <div className="relative overflow-hidden rounded-3xl border border-gold-500/30 bg-[#070e1c]/90 p-8 sm:p-12 shadow-2xl backdrop-blur-xl space-y-4">
            <div className="mx-auto grid h-16 w-16 place-items-center rounded-2xl bg-gold-400/10 border border-gold-400/30 text-gold-400">
              <Lock size={32} />
            </div>
            <h3 className="font-display text-2xl tracking-wide text-ivory-50 sm:text-3xl">
        ...
        {liveMatch ? (
          <div className="relative mx-auto max-w-4xl overflow-hidden rounded-3xl border border-emerald-500/30 bg-[#070e1c]/90 p-6 shadow-[0_0_50px_rgba(16,185,129,0.12)] backdrop-blur-xl sm:p-10">
            ...
            <div className="mb-6 flex items-center justify-between border-b border-white/10 pb-3">
              ...
              {liveMatch.label && (
                <span className="font-mono-score text-xs font-bold text-emerald-400 uppercase tracking-wider">
                  {liveMatch.label}
                </span>
              )}
            </div>
            ...
            <div className="mt-6 flex justify-center border-t border-white/10 pt-4">
              <button
                ...
                className="inline-flex items-center gap-1.5 font-mono-score text-xs font-bold tracking-wider text-emerald-400 hover:text-emerald-300 transition-colors"
              >
                <span>View Live Match Squad &amp; Team Details</span>
                <ChevronRight size={14} />
              </button>
            </div>
          </div>
        ) : (
          <div className="mx-auto max-w-4xl rounded-2xl border border-white/10 bg-[#070e1c]/60 p-8 text-center backdrop-blur-md">
            <span className="font-mono-score text-xs font-semibold uppercase tracking-widest text-ivory-400">
      ...
      <section className="mb-12">
        {/* Section Header */}
        <div className="mb-6 flex items-center justify-center gap-4 text-center">
          <div className="h-[2px] w-12 bg-gold-400/40 sm:w-24" />
